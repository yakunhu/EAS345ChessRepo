...
a_milli_positions.jsonl. Move the output file into the filtered_lichess data folder. Note that the database is updated frequently, so your file may be different from the one we provided in the filtered_lichess folder. 
