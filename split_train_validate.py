...
in_path  = "eval_db_processed.csv"
out_train = "filtered_lichess/eval_db_filtered_train.csv"
out_validate = "filtered_lichess/eval_db_filtered_validate.csv"
